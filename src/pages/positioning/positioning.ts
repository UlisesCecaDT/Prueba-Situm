...
import { NavController, NavParams, Platform, Events, LoadingController, ToastController, IonicPage } from 'ionic-angular';
...
import { PermissionsService } from '../../providers/permissions/permissions';
